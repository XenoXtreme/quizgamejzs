...
export default function ThemeToggle() {
  ...
  // Fix: Use setTimeout to defer the state update
  useEffect(() => {
  ...
  const getIcon = () => {
    if (theme === "system") {
      return (
        <Monitor className="h-5 w-5 text-sky-600 dark:text-sky-400 rotate-0 transition-all duration-500 group-hover:scale-110 drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]" />
      );
    } else if (currentTheme === "dark") {
      return (
        <Moon className="h-5 w-5 text-indigo-400 rotate-0 transition-all duration-500 group-hover:-rotate-12 group-hover:scale-110 drop-shadow-[0_0_8px_rgba(165,180,252,0.5)]" />
      );
    } else {
      return (
        <Sun className="h-5 w-5 text-amber-500 rotate-0 transition-all duration-500 group-hover:rotate-180 group-hover:scale-110 drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]" />
      );
    }
  };
