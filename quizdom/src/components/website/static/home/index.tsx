  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-linear-to-br from-yellow-50 via-white to-yellow-100 px-1 py-6 transition-colors duration-300 sm:px-2 sm:py-8 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-8 px-2 py-8 sm:gap-12 sm:py-12 md:flex-row">
        <div className="flex flex-1 flex-col items-start">
          <h1 className="mb-2 text-3xl font-extrabold tracking-tight text-gray-800 drop-shadow-lg sm:mb-4 sm:text-5xl md:text-6xl dark:text-yellow-300">
            Welcome to{" "}
            <span className="animate-linear-x bg-linear-to-r from-yellow-600 via-pink-500 to-purple-600 bg-clip-text text-transparent dark:from-yellow-400 dark:via-pink-400 dark:to-purple-400">
              Quizdom
            </span>
          </h1>
      ...
      <section className="relative z-10 mx-auto mt-10 max-w-4xl px-2 text-center sm:mt-16">
        <div className="rounded-2xl border border-yellow-200 bg-linear-to-r from-yellow-100 via-pink-100 to-purple-100 px-4 py-6 shadow-2xl sm:px-8 sm:py-10 dark:border-yellow-700 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
