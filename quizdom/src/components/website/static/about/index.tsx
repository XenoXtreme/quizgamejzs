...
const techStack = [
  ...
  {
    name: "Flowbite",
    logo: "/assets/icons/flowbite.svg",
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fffbe6] via-[#f5e9c8] to-[#e6d7b6] px-1 py-8 transition-colors duration-300 sm:px-2 sm:py-16 dark:from-[#232323] dark:via-[#2d2d2d] dark:to-[#3a2d1a]">
      <div className="mx-auto w-11/12 max-w-6xl rounded-[2.5rem] border border-yellow-100/70 bg-white/80 p-6 shadow-2xl backdrop-blur-2xl sm:w-3/4 sm:p-12 dark:border-yellow-900/40 dark:bg-gray-900/80">
        <div className="flex flex-col items-center">
          ...
          {/* Main Title */}
          <h1 className="mb-6 bg-gradient-to-tr from-yellow-700 via-yellow-600 to-yellow-400 bg-clip-text text-center text-3xl font-extrabold text-transparent drop-shadow-lg sm:mb-10 sm:text-5xl lg:text-6xl dark:from-yellow-300 dark:via-yellow-200 dark:to-yellow-100">
