            ...
            {error ? (
                ...
                >
                    ...
                    <video
                        ...
                        className="w-full cursor-pointer rounded-t-lg bg-black max-h-[60vh] sm:max-h-[80vh]"
                    ...
                    {isLoading && (
                        <div className="absolute inset-0 flex items-center justify-center bg-black/80">
                            <div className="animate-pulse flex flex-col items-center justify-center text-white">
                                ...
                                <span className="mt-2 text-sm sm:text-base">Loading video...</span>
                            </div>
                        </div>
                    )}
                    ...
                    >
                        {/* Title */}
                        <div className="absolute top-0 left-0 right-0 p-2 sm:p-3 bg-gradient-to-b from-black/80 to-transparent">
                            <h3 className="text-white text-base sm:text-lg font-medium truncate drop-shadow">{title}</h3>
                        </div>
                                    ...
                                    <div className="flex items-center ml-1 sm:ml-2">
                                        ...
                                        {!isMuted && (
                                            <input
                                                ...
                                                className="w-12 sm:w-16 h-1 ml-1 bg-gray-600 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-2 [&::-webkit-slider-thumb]:w-2 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white"
                                            />
                                        )}
                                    </div>
                                </div>
                    ...
                    {(!isPlaying && !isLoading) && (
                        <button
                            ...
                            onClick={togglePlayPause}
                        >
                            <span className="flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16 bg-blue-600/80 text-white rounded-full group-hover:bg-blue-600 transition-colors shadow-lg border-4 border-white/30">
                                <FontAwesomeIcon icon={faPlayCircle} className="text-2xl sm:text-3xl" />
                            </span>
                        </button>
                    )}
                </div>
