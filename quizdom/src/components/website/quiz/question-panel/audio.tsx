            ...
            {error ? (
                ...
                <>
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    {isLoading && (
                                        <div className="animate-pulse flex flex-col items-center justify-center bg-black bg-opacity-50 w-full h-full text-white">
                                            ...
                                            <span className="mt-2 text-xs sm:text-base">Loading audio...</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                    ...
                    <div className="text-center mb-2">
                        <h3 className="text-base sm:text-lg font-medium text-[silver] truncate">{title}</h3>
                    </div>
                    ...
                    {/* Main controls */}
                    <div className="flex flex-wrap items-center justify-center space-x-2 sm:space-x-4 mb-4">
