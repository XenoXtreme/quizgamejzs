  ...
  return (
    <div className={nunito.className}>
      ...
      >
        ...
        />
        <section className="relative z-10 mt-4 flex w-full flex-col items-center justify-center sm:mt-8">
          {/* Prelims */}
          <section
            className={`my-2 flex h-auto w-[95vw] cursor-pointer flex-col items-center justify-center overflow-hidden rounded-lg border border-blue-100 bg-white/80 px-2 shadow-lg transition-all duration-200 hover:-translate-y-1 hover:scale-[1.03] hover:bg-blue-50 sm:my-4 sm:px-4 lg:h-[25vh] lg:w-[63vw] lg:flex-row dark:border-blue-900 dark:bg-gray-900/60 dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.7)] dark:backdrop-blur-md dark:hover:bg-gray-800/80`}
          >
            <div className="mr-0 mb-2 flex h-4/5 w-full items-center justify-center lg:mr-2 lg:mb-0 lg:w-1/5 sm:lg:mr-[13%]">
              <img
                ...
                loading="lazy"
                alt="Logo"
                className="xs:w-20 xs:h-20 h-16 w-16 rounded-xl shadow sm:h-24 sm:w-24 lg:h-28 lg:w-28"
              />
            </div>
            <div className="mb-2 flex h-4/5 w-full flex-col items-center justify-center lg:mb-0 lg:w-3/5">
              <h1 className="mb-1 rounded-lg bg-white/70 px-2 py-1 text-lg font-extrabold text-gray-900 shadow sm:mb-2 sm:px-4 sm:py-2 sm:text-2xl dark:bg-gray-900/70 dark:text-gray-100">
                Prelims
              </h1>
              <p className="w-4/5 rounded-lg px-1 py-1 text-xs text-gray-700 sm:px-3 sm:text-base dark:text-gray-300">
            ...
            <div className="flex w-full items-center justify-center lg:w-1/5">
              ...
              >
                <button
                  className={`w-full cursor-pointer rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 px-2 py-1 text-xs font-semibold text-white shadow transition hover:from-blue-800 hover:to-blue-600 sm:px-4 sm:py-2 sm:text-base`}
                >
                  View
                </button>
              </Link>
